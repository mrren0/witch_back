...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("skin", sa.String(), nullable=False, server_default=sa.text("'38ef8571-0e7d-4926-88db-fcb5a8892adb'")),
    ...
    op.create_table(
        ...
        sa.Column("id_product_item", sa.Integer(), sa.ForeignKey("products_item.id"), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("purchaseId", sa.String(), nullable=False, server_default=sa.text("''")),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
    )
    ...
    op.create_table(
        ...
        sa.Column("finish_at", sa.DateTime(timezone=True)),
        sa.Column("level_ids", postgresql.JSON(astext_type=sa.Text()), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("rewards", postgresql.JSON(astext_type=sa.Text()), nullable=False),
    )
